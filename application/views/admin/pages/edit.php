...
<div class="container">
  <form method="post" action="<?php echo site_url("/admin/news"); ?>/<?php echo $news_item["id"]; ?>" enctype="multipart/form-data">
      <!-- Title -->
    ...
    <div class="control-group <?php echo (form_error('body')?'has-error':''); ?>">
        ...
        <div class="controls">
            <textarea name="body" id="body" cols="30" rows="5" placeholder="Content" class="form-control"> <?php echo $news_item['body']; ?></textarea>
    ...
    <div class="fileinput fileinput-new control-group <?php echo (form_error('image_path')?'has-error':''); ?>" data-provides="fileinput">
      <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 200px; height: 100px;">
          <img src="<?php echo base_url($news_item['image_path']); ?>" style="width: 200px; height: 100px;" alt="">
      </div>
